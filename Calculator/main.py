...
# Row 1
one_button = Button(
    window, text="1", command=lambda: set_number(1), width=3, bg="black", fg="white"
)
one_button.place(x=2, y=23)

two_button = Button(
    window, text="2", command=lambda: set_number(2), width=3, bg="black", fg="white"
)
two_button.place(x=35, y=23)

three_button = Button(
    window, text="3", command=lambda: set_number(3), width=3, bg="black", fg="white"
)
three_button.place(x=68, y=23)

addition_button = Button(
    window, text="+", command=lambda: set_number("+"), width=3, bg="black", fg="white"
)
addition_button.place(x=101, y=23)

# Row 2
four_button = Button(
    window, text="4", command=lambda: set_number(4), width=3, bg="black", fg="white"
)
four_button.place(x=2, y=51)

five_button = Button(
    window, text="5", command=lambda: set_number(5), width=3, bg="black", fg="white"
)
five_button.place(x=35, y=51)

six_button = Button(
    window, text="6", command=lambda: set_number(6), width=3, bg="black", fg="white"
)
...
# Row 3
seven_button = Button(
    window, text="7", command=lambda: set_number(7), width=3, bg="black", fg="white"
)
seven_button.place(x=2, y=79)

eight_button = Button(
    window, text="8", command=lambda: set_number(8), width=3, bg="black", fg="white"
)
eight_button.place(x=35, y=79)

nine_button = Button(
    window, text="9", command=lambda: set_number(9), width=3, bg="black", fg="white"
)
...
# Row 4
zero_button = Button(
    window, text="0", command=lambda: set_number(0), width=3, bg="black", fg="white"
)
...
equals_button = Button(
    window, text="=", command=equals, width=3, bg="black", fg="white"
)
